...
// `slug` identifica o restaurante nesta tela pública sem QR Code (o totem é
// um dispositivo físico fixo do balcão, aberto direto nesse link — ver
// decisões de multi-tenant no schema.prisma, model Restaurant).
